...
**总代码量：7843 行 Rust（17 个 crate）+ 1282 行支持文件（Shell/Markdown/Toml/Dockerfile）**
...
│   ├── tremolite-plugin/         # 插件系统（Plugin trait + 进程加载器）
...
- [ ] **基准测试** — 17 个 crate 的编译时间、内存占用、LLM 调用延迟的基准测试体系
